  ...
  <div class="p-4 md:p-6 lg:p-8 max-w-4xl mx-auto">
    ...
    >
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div>
          ...
          <input
            ...
            required
          />
          <p v-if="countriesLoading" class="mt-1 text-xs text-gray-500">
            Loading countries...
          </p>
          <p v-else-if="countriesError" class="mt-1 text-xs text-red-600">
            {{ countriesError }}
          </p>
        </div>
        ...
        <div>
          <label class="block text-sm font-medium text-gray-700 mb-1">Number of looks</label>
          <input
      ...
      <div class="flex items-center justify-between pt-2">
        ...
        >
          ...
          <span>{{ loading ? 'Generating looks...' : 'Generate looks' }}</span>
        </button>
      </div>
    </form>
    ...
    <div v-if="looks.length > 0" class="space-y-4">
      <div class="flex items-center justify-between">
        <h2 class="text-2xl font-semibold text-gray-800">Suggested outfits</h2>
    ...
    <div v-else-if="!loading && hasRequested" class="text-center text-gray-500 mt-8">
